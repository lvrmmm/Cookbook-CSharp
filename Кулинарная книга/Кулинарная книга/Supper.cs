...
{
    public partial class Supper : Form
    {
        public Supper()
        {
            InitializeComponent();
        ...
        /// <param name="e"></param>
        private void Supper_Load(object sender, EventArgs e)
        {
            GetColumns();
        ...
        private void RefreshData(DataGridView dataGridView)
        {
            ...
            List<Recipes> dinners = (from p in recipes where p.Type == "Ужин" select p).ToList();
            ...
            label2_countBreakfast.Text = "Всего рецептов ужина: "  + countbr.ToString(); // Отображаем количество завтраков
        }
